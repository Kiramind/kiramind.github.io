...
["dart.async", "dart:async", , P, {
  ...
  Future_wait_handleError: {
    "^": "Closure:12;box_0,eagerError_1,result_2",
  ...
  Future_wait_closure: {
    "^": "Closure:16;box_0,eagerError_3,result_4,pos_5",
...
["hex", "package:Hex/hex.dart", , Y, {
  ...
  Hex: {
    ...
    static: {"^": "Hex_TWOPI_SIXTH,Hex_neighbors,Hex_diagonals", Hex$: function(pixelSize, q_coord, r_coord) {
        ...
        t5 = t2[t5][1];
        t5 = new Y.Hex(null, hex.pixelSize, -1, -1, t1 + t3 * scale, t4 + t5 * scale, null, null);
...
["hexmap", "package:HexPeriment/game/game_info.dart", , M, {
  ...
  MapInfo: {
    ...
    _generateHexes$1: function(rdm) {
      ...
      for (dx = -this.halfNbHex_Q, t1 = this.idToHex; t2 = this.halfNbHex_Q, dx <= t2; ++dx) {
        ...
        for (dy = min_dy; dy <= max_dy; ++dy) {
          dz = C.JSNumber_methods.toInt$0(C.JSInt_methods.roundToDouble$0(t3 - dy));
    ...
    getSelectedHexFromPixel$2: function(x, y) {
      var t1, t2, cx, q, r, rx, ry, rz, x_diff, y_diff, z_diff;
      t1 = this.mapCenter;
      t2 = t1.x;
      if (typeof x !== "number")
        return x.$sub();
      ...
      if (typeof t1 !== "number")
        return H.iae(t1);
      q = 0.6666666666666666 * cx / this.hexSize;
      r = (-0.3333333333333333 * cx + 0.3333333333333333 * Math.sqrt(H.checkNum(3)) * (y - t1)) / this.hexSize;
      y = -q - r;
      ...
      if (x_diff > y_diff && x_diff > z_diff)
        ...
        t1 = -rx;
        if (y_diff > z_diff)
          C.JSNumber_methods.toInt$0(C.JSInt_methods.roundToDouble$0(t1 - rz));
        else
          rz = C.JSNumber_methods.toInt$0(C.JSInt_methods.roundToDouble$0(t1 - ry));
      }
      return this.idToHex.$index(0, Y.Hex__computeId(rz, rx));
    },
  ...
  MapInfo_applyToHexRing_closure: {
    "^": "Closure:13;box_0,radius_1,execute_2",
    call$1: function(dir) {
...
["hexvisibility", "package:HexPeriment/algorithm/visibilityalgorithm.dart", , Q, {
  ...
  VisibilityAlgorithm__visibleRayToDiag_closure: {
    "^": "Closure:13;box_1,box_0,this_2,startAltitude_3",
    call$1: function(dir) {
      var prevHex, t1, t2;
...
["", "visibility.dart", , L, {
  "^": "",
  main: [function() {
    var canvasApp = new L.VisibilityApp(N.Logger_Logger("VisibilityApp"), null, null, null, 4, C.SelectionMode_Land, null, 3);
    canvasApp.VisibilityApp$0();
    N.Logger_Logger("").set$level(C.Level_INFO_800);
    N.Logger_Logger("").get$onRecord().listen$1(new L.main_closure());
    U.GameImage_load([C.ImageType_h2R, C.ImageType_mKv, C.ImageType_S72, C.ImageType_QUj, C.ImageType_chs, C.ImageType_dYb, C.ImageType_GBG, C.ImageType_Ju4, C.ImageType_wsa, C.ImageType_T7e, C.ImageType_Lim, C.ImageType_AKW]).then$1(new L.main_closure0(canvasApp));
  }, "call$0", "main$closure", 0, 0, 2],
  VisibilityApp: {
    "^": "Object;log,theCanvas,context,hexMap,halfNbHex_Q,selectionMode,tempHex,visibilityRadius",
    _initInteraction$0: function() {
      var t1, sliderLabel, slider;
      t1 = J.get$onClick$x(this.theCanvas);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new L.VisibilityApp__initInteraction_closure(this)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      C.JSArray_methods.forEach$1([C.SelectionMode_Hill, C.SelectionMode_Mountain, C.SelectionMode_Land], new L.VisibilityApp__initInteraction_closure0(this));
      sliderLabel = document.querySelector("#viewRangeLabel");
      slider = document.querySelector("#viewRange");
      t1 = J.get$onInput$x(slider);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new L.VisibilityApp__initInteraction_closure1(this, sliderLabel, slider)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      t1 = J.get$onClick$x(document.querySelector("#clearButton"));
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new L.VisibilityApp__initInteraction_closure2()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      t1 = J.get$onMouseMove$x(this.theCanvas);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new L.VisibilityApp__initInteraction_closure3(this)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    },
    ...
    computeVisibility$1: function(startHex) {
      var vHex, t1;
      if (startHex == null)
        return;
      vHex = this.hexMap.idToHex.$index(0, J.get$id$x(startHex));
      this.hexMap.clearVisibility$0();
      if (vHex != null) {
        t1 = N.Logger_Logger("VisibilityAlgorithm");
        this.hexMap.applyToHexRing$3(startHex, this.visibilityRadius, new L.VisibilityApp_computeVisibility_closure(this, new Q.VisibilityAlgorithm(vHex, t1)));
        J.clearRect$4$x(this.context, 0, 0, J.get$width$x(this.theCanvas), J.get$height$x(this.theCanvas));
        this.hexMap.drawMap$0();
      }
    },
    VisibilityApp$0: function() {
      var t1, rdr, t2, t3, t4;
      ...
      t3 = N.Logger_Logger("MapInfo");
      t4 = P.SplayTreeMap$(null, null, P.String, M.GameHex);
      t3 = new M.MapInfo(t3, rdr, "NO_NAME", null, null, null, null, null, null, null, 0, 0, 2, false, t4, P.SplayTreeMap$(null, null, P.String, M.GameObject), C.CharacterType_PXO, P.SplayTreeMap$(null, null, P.String, D.AStarObject));
      t3.MapInfo$6(t1, t2, this.halfNbHex_Q, rdr, false, false);
      this.hexMap = t3;
      t3 = t4.$index(0, t3.fromHexId);
      this.tempHex = t3;
      this.computeVisibility$1(t3);
      this._initInteraction$0();
    },
    static: {"^": "VisibilityApp_HTML_ACTIVE_CLASS,VisibilityApp_logElement"}
  },
  VisibilityApp__initInteraction_closure: {
    "^": "Closure:13;this_0",
    call$1: function(e) {
      var t1, t2, x, y, selectedHex;
      ...
      y = t1.get$y(t1);
      t1 = this.this_0;
      selectedHex = t1.hexMap.getSelectedHexFromPixel$2(x, y);
      if (selectedHex != null) {
        switch (t1.selectionMode) {
          case C.SelectionMode_Land:
            t1.hexMap.changeType$2(selectedHex, C.HexType_aLp);
            break;
          case C.SelectionMode_Mountain:
            t1.hexMap.changeType$2(selectedHex, C.HexType_MUw);
            break;
          case C.SelectionMode_Hill:
            t1.hexMap.changeType$2(selectedHex, C.HexType_PLD);
            break;
        }
  ...
  VisibilityApp__initInteraction_closure0: {
    "^": "Closure:13;this_1",
    call$1: function(mode) {
      var t1, t2;
      t1 = this.this_1;
      t2 = J.get$onClick$x(t1._getButtonFromMode$1(mode));
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new L.VisibilityApp__initInteraction__closure(t1, mode)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
    }
  },
  VisibilityApp__initInteraction__closure: {
    "^": "Closure:13;this_2,mode_3",
    call$1: function(e) {
      var t1, t2;
      t1 = this.this_2;
      t2 = this.mode_3;
  ...
  VisibilityApp__initInteraction_closure1: {
    "^": "Closure:13;this_4,sliderLabel_5,slider_6",
    call$1: function(e) {
      var newValue, newVal, t1;
      newValue = J.get$value$x(this.slider_6);
      J.set$value$x(this.sliderLabel_5, newValue);
      newVal = H.Primitives_parseInt(newValue, null, null);
      t1 = this.this_4;
      if (!J.$eq(newVal, t1.visibilityRadius)) {
        t1.visibilityRadius = newVal;
        t1.computeVisibility$1(t1.tempHex);
      }
    }
  },
  VisibilityApp__initInteraction_closure2: {
    "^": "Closure:13;",
    call$1: function(e) {
      $.get$VisibilityApp_logElement().textContent = "";
      return "";
    }
  },
  VisibilityApp__initInteraction_closure3: {
    "^": "Closure:22;this_7",
    call$1: function(e) {
      var t1, t2, mousex, mousey, currentHex;
      t1 = J.getInterceptor$x(e);
      t2 = t1.get$offset(e);
      mousex = t2.get$x(t2);
      t1 = t1.get$offset(e);
      mousey = t1.get$y(t1);
      t1 = this.this_7;
      currentHex = t1.hexMap.getSelectedHexFromPixel$2(mousex, mousey);
      if (!J.$eq(currentHex, t1.tempHex)) {
        t1.tempHex = currentHex;
        t1.computeVisibility$1(currentHex);
      }
    }
  },
  VisibilityApp_computeVisibility_closure: {
    "^": "Closure:13;this_0,vAlgo_1",
    call$1: function(hex) {
  ...
  main_closure0: {
    "^": "Closure:13;canvasApp_0",
    call$1: function(_) {
      this.canvasApp_0.hexMap.drawMap$0();
    }
  },
  SelectionMode: {
    "^": "Object;name>",
    static: {"^": "SelectionMode_HILL,SelectionMode_MOUNTAIN,SelectionMode_LAND"}
  }
},
1],
]);
...
C.SelectionMode_Hill = new L.SelectionMode("Hill");
C.SelectionMode_Land = new L.SelectionMode("Land");
C.SelectionMode_Mountain = new L.SelectionMode("Mountain");
...
Isolate.$lazy($, "logElement", "VisibilityApp_logElement", "get$VisibilityApp_logElement", function() {
...
//# sourceMappingURL=visibility.dart.js.map
